...
![GitHub repo size](https://img.shields.io/github/repo-size/zrsx/termux-ng)
[![Packages last build status](https://github.com/zrsx/termux-ng/actions/workflows/packages.yml/badge.svg?branch=master)](https://github.com/zrsx/termux-ng/actions)
[![Docker image status](https://github.com/zrsx/termux-ng/workflows/Docker%20image/badge.svg)](https://hub.docker.com/r/termux/package-builder)
[![Repology metadata](https://github.com/zrsx/repology-metadata/workflows/Repology%20metadata/badge.svg)](https://repology.org/repository/termux)
